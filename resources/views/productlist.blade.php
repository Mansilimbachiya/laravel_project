...
<html lang="en">
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-10">
                            <h1 class="page-header">Manage Product List</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    ...
                    <a href = "/product/add">
                    <button type = "submit" name = "submit" value = "submit"  class="btn btn-primary btn-sm">ADD PRODUCT</button>
                    </a>
                    </div>
  ...
  <tbody>
    ...
    <tr>
    <td> <?php echo $i++; ?></td>
    <td> <img src="{{url('/')}}/profile/<?php echo $r->pimage; ?>" style="height: 40px;"> </td>
    <td> <?php echo $r->pname; ?></td>
    <td> ₹ <?php echo $r->pprice; ?>/-</td>
    <td> 
        <a href = "/product/view/{{ $r->pid }}">
