...
<b>Username</b> : <?php echo $u->uname ; ?>
<br>
<b>Mobile no</b> : <?php echo $u->umobileno ; ?>
<br>
<?php
...
?>
<b>Address</b> : <?php echo $oh->orderaddress ; ?>
<?php
}
?>
</div>
 ...
 <br>
  ...
  <tbody>
    ...
    { 
     ...
     $ohid = $c->orderhistoryid;
?>
    <tr>
    <td><?php echo $i++; ?></td> 
    <td><?php echo $c->pname ;?></td>
      <td><?php echo $c->oqty ;?></td>
      <td><?php echo $c->ocpprice ;?></td>
      <td><?php echo $c->ocpprice * $c->oqty ;?></td>
    </tr>
...
<br>
<form  method = "post" action = "{{url('/')}}/order/review">
            @csrf
  
  <input type = "hidden" name = "orderhistoryid" value = "<?php echo $ohid; ?>">
  <input type = "hidden" name = "orderuserid" value = "<?php echo $uid; ?>">
  <?php
   }
   ?>
   <label>Tell us about your experience :</label>
<textarea class="form-control" name = "review" style = "border:2px solid grey;">
 </textarea>
