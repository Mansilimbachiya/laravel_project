        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <a href = "/bringer">
                    <button type = "submit" name = "submit" value = "submit"  class="btn btn-primary btn-sm">BRINGER LIST</button>
                    </a>
                    </div>
                    <br><br>
                    <form method = "post" action = "{{url('/')}}/bringer/insert" autocomplete = "off">
                    @csrf
                    <div class="form-group">
                    <label >Bringer Name :</label>
                    <input type="text" class="form-control" name = "bname" placeholder="Bringer Name" required>
                    </div>

                    <div class="form-group">
                    <label >Bringer MobileNo :</label>
                    <input type="text" class="form-control" name = "bmobileno" placeholder="Bringer MobileNo" required>
                    </div>

                    <div class="form-group">
                    <label >Bringer Person Name :</label>
                    <input type="text" class="form-control" name = "bpersonname" placeholder="Bringer Person Name" required>
                    </div>
