        ...
        <div id="wrapper">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">         
                       ...
                       <li>
                        ...
                        <li>
                            <a href="/confirmorder" class="active"><i class="fa fa-check"></i></i> Confirm Order</a>
                        </li>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <a href = "/stockcarrier">
                    <button type = "submit" name = "submit" value = "submit"  class="btn btn-primary btn-sm">STOCK CARRIER</button>
                    </a>
                    </div>
                    <br><br>
                    <form method = "post" action = "{{url('/')}}/stockcarrier/insert" autocomplete = "off">
                    @csrf
                    <div class="form-group">
                    <label >Stock Carrier Name :</label>
                    <input type="text" class="form-control" name = "scname" placeholder="Stock Carrier Name" required>
                    </div>

                    <div class="form-group">
                    <label >Stock Carrier MobileNo :</label>
                    <input type="text" class="form-control" name = "scmobileno" placeholder="Stock Carrier MobileNo" required>
                    </div>

                    <div class="form-group">
                    <label >Stock Carrier Person Name :</label>
                    <input type="text" class="form-control" name = "scpersonname" placeholder="Stock Carrier Person Name" required>
                    </div>
