...
<section id="contact" class="contact">
  ...
  <tbody>
   ...
   ?>
    <tr>
      <td><?php echo $i++; ?></td>
      <td> <img src="{{url('/')}}/profile/<?php echo $c->pimage; ?>" style="height: 50px;"> </td>
      <td><?php echo $c->date; ?></td>
      <td><?php echo $c->pname; ?></td>
      <td> ₹ <?php echo $c->pprice; ?></td>

      <td>
      
        <form method = "post" action = "{{url('/')}}/minus/qty">
          @csrf
          <input type = "hidden" name = "cid" value = "{{ $c->cid }}">
          <input type = "hidden" name = "quantity" value = "{{ $c->qty }}">
          <input type = "hidden" name = "price" value = "{{ $c->pprice }}">
          <button type = "submit" name = "submit" value = "submit" class = "btn btn-link btn-sm">
        <i class = "fa fa-minus"></i></button></form>
        <?php echo $c->qty; ?>


        <form method = "post" action = "{{url('/')}}/add/qty">
        @csrf
        <input type = "hidden" name = "cid" value = "{{ $c->cid }}">
        <input type = "hidden" name = "quantity" value = "{{ $c->qty }}">
        <input type = "hidden" name = "price" value = "{{ $c->pprice }}">
      ...
      <td> ₹ <?php echo $c->qty * $c->cpprice; ?></td>
      <td>
        <a href = "/delete/cart/<?php echo $c->cid; ?>">
