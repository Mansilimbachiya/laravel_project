        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-10">
                            <h1 class="page-header">Cancel Order</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
...
?>
    <tr>
    <td><?php echo $i++; ?></td>
    <td><?php echo $c->orderdate; ?></td>
    <td><?php echo $c->uname; ?></td> 
      <td><?php echo $c->orderaddress; ?></td>
      <td>
        <form method = "post" action = "{{url('/')}}/cancelorder/view">
            @csrf
    ...
    <td>
        <form method = "post" action = "{{url('/')}}/cancelorder/renew">
            @csrf
            <input type = "hidden" name = "id" value = "<?php echo $c->orderhistoryid; ?>">
        <input type = "hidden" name = "uid" value = "<?php echo $c->uid; ?>">
