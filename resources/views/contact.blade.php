...
<html lang="en">
  ...
  <tbody>
    ...
    <tr>
    <td><?php echo $i++; ?></td>
      <td><?php echo $co->coname; ?></td>
      <td><?php echo $co->coemail; ?></td>
      <td><?php echo $co->cocontactno; ?></td>
      <td><?php echo $co->comessage; ?></td>
      <td> 
          <?php
          if($co->costatus == 1)
          {
          ?>
            <a href = "/contact/status/{{ $co->coid }}">
        ...
        <?php
          ...
          {
            ?>
            <a href = "/contact/dstatus/{{ $co->coid }}">
