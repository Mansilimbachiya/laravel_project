        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <br><br>
                    <form enctype="multipart/form-data" method = "post" action="{{url('/')}}/galleryimage/insert" autocomplete = "off">
                    @csrf
                    <div class="form-group">
                    <label >Gallery Image :</label>
                    <input type="file" class="form-control" name = "gimage" placeholder="Gallery Image" required>
                    </div>

                    <div class="form-group">
                    <label >Gallery Image Name :</label>
                    <input type="text" class="form-control" name = "gimgname" placeholder="Gallery Image Name" required>
                    </div>
