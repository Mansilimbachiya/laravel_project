        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <img src="{{url('/')}}/profile/<?php echo $v->pimage; ?>" style="height: 50px;"> 
                    </div>

                    <div class="form-group">
                    <label >Product Name :</label>
                    <input type="text" class="form-control" name = "pname" placeholder="Product Name" value="<?php echo $name; ?>" required>
                    </div>
                 ...
                 <option value="0"> Select Sub Category </option>
                    ...
                    <input type="text" class="form-control" name = "price" placeholder="Product Prices" value="<?php echo $price; ?>" required>
                    </div>

                    <div class="form-group">
                    <label >Product Date :</label>
                    <input type="date" class="form-control" name = "pdate" placeholder="Product date" value="<?php echo $date; ?>" required>
                    </div>
