        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <br><br>
                    <form enctype="multipart/form-data" method = "post" action="{{url('/')}}/product/insert" autocomplete = "off">
                    @csrf
                    <div class="form-group">
                    <label >Product Image :</label>
                    <input type="file" class="form-control" name = "pimage" placeholder="Product Image" required>
                    </div>
                    ...
                    <option value="<?php echo $m->cid; ?>"> <?php echo $m->cname; ?> </option>
                 ...
                 <option value="0"> Select Sub Category </option>
                    ...
                    <input type="text" class="form-control" name = "pprice" placeholder="Product Prices" required>
                    </div>

                    <div class="form-group">
                    <label >Product Date :</label>
                    <input type="date" class="form-control" name = "pdate" placeholder="Product date" required>
                    </div>
