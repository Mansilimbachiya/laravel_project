...
<html lang="en">
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <form class="form-inline" method = "post" action = "{{url('/')}}/payment/datefilter">
                        @csrf
  ...
  <button type="submit" name = "submit" value = "submit" class="btn btn-primary mb-2">Search</button>
</form>
...
?>
    ...
    ?></td>
    <td><?php 
    $userid = $c->orderuserid; 

    $usrrow = DB::table('userlist')
    ->where('uid',$userid)
    ->get(); 
    ...
    ?></td>
    <td><?php echo $c->ordertotalamount; ?></td>
    <td>
    <form method = "post" action = "{{url('/')}}/payment/view">
            @csrf
            <input type = "hidden" name = "id" value = "<?php echo $c->orderhistoryid; ?>">
