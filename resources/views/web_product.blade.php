          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
            <div class="chef-member">
              <div class="member-img">
                <img src="{{url('/')}}/profile/<?php echo $p->pimage; ?>" style="height: 200px;" class="img-fluid">
...
<input type="hidden" name="pname" value="<?php echo $p->pname; ?>">
...
<button type="submit" name="submit" value="submit" class="btn">
                ...
                <span style="color: red; font-size: 18px;">₹ <?php echo $p->pprice; ?> /-</span>
