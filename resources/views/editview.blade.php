        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <a href = "/product">
                    <button type = "submit" name = "submit" value = "submit"  class="btn btn-primary btn-sm">PRODUCT LIST</button>
                    </a>
                    </div>
                    <br><br>
                    <form enctype="multipart/form-data" method = "post" action="{{url('/')}}/product/update/'.$editdata->pid)" autocomplete = "off">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                    <label >Product Image :</label>
                    <input type="file" class="form-control" name = "pimage" placeholder="Product Image" value="<?php echo $editdata->pimage; ?>"  required>
                    </div>

                    <div class="form-group">
                    <label >Product Name :</label>
                    <input type="text" class="form-control" name = "pname" placeholder="Product Name" value="<?php echo $editdata->pname; ?>" required>
                    </div>

                    <div class="form-group">
                    <label> Select Category :</label>
                    <select name="cid" id="maincat" class="form-control">
                 ...
                 <option value="0"> Select Sub Category </option>
                    ...
                    <input type="text" class="form-control" name = "price" placeholder="Product Prices" value="<?php echo $editdata->pprice; ?>" required>
                    </div>

                    <div class="form-group">
                    <label >Product Date :</label>
                    <input type="date" class="form-control" name = "pdate" placeholder="Product date" value="<?php echo $editdata->pdate; ?>" required>
                    </div>
