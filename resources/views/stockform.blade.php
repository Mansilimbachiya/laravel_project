        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <a href = "/stock">
                    <button type = "submit" name = "submit" value = "submit"  class="btn btn-primary btn-sm">STOCK LIST</button>
                    </a>
                    </div> 

                    <br><br>
                    <form method = "post" action = "{{url('/')}}/stock/insert" autocomplete = "off">
                        @csrf
                    <div class="form-group">
                    <label >Stock Product Id :</label>
                    <input type="text" class="form-control" name = "stockpid" placeholder="Stock Product Id" required>
                    </div>

                    <div class="form-group">
                    <label >Stock Category Id :</label>
                    <input type="text" class="form-control" name = "stockcid" placeholder="Stock Category Id" required>
                    </div>

                    <div class="form-group">
                    <label > Total Stock :</label>
                    <input type="text" class="form-control" name = "totalstock" placeholder="Total Stock" required>
                    </div>

                    <div class="form-group">
                    <label >Stock Pieces :</label>
                    <input type="text" class="form-control" name = "stockpcs" placeholder="Stock Pieces">
                    </div>
