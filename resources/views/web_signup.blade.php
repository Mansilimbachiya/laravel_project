    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <form enctype="multipart/form-data" method = "post" action="{{url('/')}}/web/create" autocomplete = "off">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control" name = "umobileno" placeholder="User Mobileno" required> <br>
                    </div>
                    <div class="form-group">
                       <input type="text" class="form-control" name = "uaddress" placeholder="User Address" required><br>
                    </div>
                    <div class="form-group">
                        <input type="file" class="form-control" name = "uimage" placeholder="User Image" required><br>
                    </div>
                    <div class="form-group">
                     <input type="text" class="form-control" name = "uusername" placeholder="User Username" required><br>
                    </div>
                <div class="form-group">
                     <input type="password" class="form-control" name = "upassword" placeholder="User Password" required><br>
                    </div>
