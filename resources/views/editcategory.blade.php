        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <a href = "/category">
                    <button type = "submit" name = "submit" value = "submit"  class="btn btn-primary btn-sm">CATEGORY LIST</button>
                    </a>
                    </div>
                    <br><br>
                   ...
                   <form method = "post" action="{{url('/')}}/category/update" autocomplete = "off">
                        @csrf
                   ...
                   <input type="hidden" name="cid" value="<?php echo $editdata->cid; ?>">
                    ...
                    <input type="text" value="<?php echo $editdata->cname; ?>" class="form-control" name = "cname" placeholder="Category Name" required>
                    </div>
