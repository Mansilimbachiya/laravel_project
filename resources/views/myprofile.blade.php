...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Category</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            ...
            @foreach($category as $cat)
              <li><a href="/web/category">{{ $cat->cname }}</a></li>
            @endforeach
            </ul>
          </li>
    ...
    <section id="contact" class="contact">
      ...
      <p>
        <a href="{{url('/')}}/web/profile" style="color: black;"><b>My Profile</b></a> |
    
           <a href="{{url('/')}}/web/orderhistory" style="color: black;" >Order History</a> |

        <a href="{{url('/')}}/web/logout" style="color: black;">Logout</a>
    ...
    <div style="height: 100px;"> </div>       
         ...
         <img src="{{url('/')}}/profile/<?php echo $u->uimage; ?>" style="width: 80%;">
                </div>

                <div class="col-lg-8">
                <h2 style="font-size: 40px;">Welcome <?php echo $u->uname ; ?></h2>
                Mobile No : <?php echo $u->umobileno ; ?>
                <br>
                Username : <?php echo $u->uusername ; ?>
                <br>
                Address : <?php echo $u->uaddress ; ?>
            <?php
              }
