...
<form action="{{url('/')}}/confirmorder" method="post" autocomplete = "off">
          @csrf
                    
                    <div class="form-group">
                      <label style = "font-size:25px;"> &nbsp; Address : </label>
                       <input type="text" class="form-control" name = "orderaddress" placeholder="Enter Your Address"><br>
                    </div>
                  
                    <button type = "submit" name = "submit" value = "submit"  class="btn btn-primary">Confirm Order</button>
                    </form>
