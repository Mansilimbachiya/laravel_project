    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          ...
          <p>Order<span> History</span></p>
        </div>
    
      <p>
        <a href="{{url('/')}}/web/profile" style="color: black;">My Profile</a> |
    
           <a href="{{url('/')}}/web/orderhistory" style="color: black;" ><b>Order History</b></a> |
...
<table class="table">
  ...
  <tbody>
    ...
    <td><?php echo $i++; ?></td>
      ...
      <td><?php echo $o->orderaddress; ?></td>
      <td><?php echo $o->ordertotalamount; ?></td>
      <td>
        <a href = "/orderhistory/view/{{ $o->orderhistoryid }}">
