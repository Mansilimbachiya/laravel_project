...
<html lang="en">
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    foreach($viewuser as $v)

                    {
                       $image = $v->uimage;
                       $name = $v->uname;
                       $mobileno = $v->umobileno;
   ...
   <form enctype="multipart/form-data" method = "post" action="{{url('/')}}/web/create" autocomplete = "off">
                    @csrf
                    
                    <div class="form-group">
                    <label>User Image :</label>
                    <img src="{{url('/')}}/profile/<?php echo $v->uimage; ?>" style="height: 50px;"> 
                    </div>

                    <div class="form-group">
                    <label>User Name :</label>
                    <input type="text" class="form-control" name = "uname" placeholder="User Name" value="<?php echo $name; ?>" required>
                    </div>

                    <div class="form-group">
                    <label>User Mobileno :</label>
                      <input type="text" class="form-control" name = "umobileno" placeholder="User Mobileno" value="<?php echo $mobileno; ?>" required> <br>
                    </div>

                    <div class="form-group">
                    <label>User Password :</label>
                      <input type="text" class="form-control" name = "upassword" placeholder="User Password" value="<?php echo $password; ?>" required> <br>
                    </div>
                   
                    <div class="form-group">
                    <label>User Username :</label>
                     <input type="text" class="form-control" name = "uusername" placeholder="User Username" value="<?php echo $username; ?>" required><br>
                    </div>

                    <div class="form-group">
                    <label>User Address :</label>
                      <input type="text" class="form-control" name = "uaddress" placeholder="User Address" value="<?php echo $address; ?>" required> <br>
                    </div>
