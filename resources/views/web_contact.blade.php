...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <section id="contact" class="contact">
      ...
      <form enctype="multipart/form-data" method = "post" action="{{url('/')}}/web/contactnumber" autocomplete = "off">
                    @csrf
                    ...
                    <div class="form-group">
                       <input type="text" class="form-control" name = "contactno" placeholder="Your Contact No" required><br>
                    </div>
