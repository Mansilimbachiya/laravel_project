...
<html lang="en">
  ...
  <?php
    ...
    <tr>
      <td> <?php echo $i++; ?></td>
      <td> <img src="{{url('/')}}/profile/<?php echo $r->uimage; ?>" style="height: 40px;"></td>
      <td> <?php echo $r->uname; ?></td>
      <td> <?php echo $r->umobileno; ?></td>
      <td> <?php echo $r->uusername; ?></td>
      <td> 
        <a href = "/user/view/{{ $r->uid }}">
