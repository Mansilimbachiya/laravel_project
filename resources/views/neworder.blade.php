...
?>
    <tr>
    <td><?php echo $i++; ?></td>
    <td><?php echo $n->orderdate; ?></td>
      <td><?php echo $n->uname; ?></td> 
      <td><?php echo $n->orderaddress; ?></td>
      <td>
        <form method = "post" action="{{url('/')}}/neworder/view">
        <input type = "hidden" name = "id" value = "<?php echo $n->orderhistoryid; ?>">
        <input type = "hidden" name = "uid" value = "<?php echo $n->uid; ?>">
            @csrf
    ...
    <td>
        <form method = "post" action="{{url('/')}}/neworder/cancel">
        <input type = "hidden" name = "id" value = "<?php echo $n->orderhistoryid; ?>">
        <input type = "hidden" name = "uid" value = "<?php echo $n->uid; ?>">
            @csrf
    ...
    <td>
        <form method = "post" action="{{url('/')}}/neworder/allocate">
        <input type = "hidden" name = "id" value = "<?php echo $n->orderhistoryid; ?>">
        <input type = "hidden" name = "uid" value = "<?php echo $n->uid; ?>">
            @csrf
